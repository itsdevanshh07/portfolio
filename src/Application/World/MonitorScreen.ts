...
export default class MonitorScreen extends EventEmitter {
    ...
    /**
     * Creates the branding for the monitor bezel
     */
    createBranding() {
        ...
        globe.style.width = '48px';
        globe.style.height = '48px';
        globe.style.marginRight = '12px';
        ...
        inc.innerText = 'devansh.inc';
        inc.style.fontSize = '18px';
        inc.style.fontWeight = 'bold';
        inc.style.opacity = '0.5';
        inc.style.marginTop = '2px';

        textContainer.appendChild(name);
        textContainer.appendChild(inc);
        ...
        // Position it on the bottom left of the bezel
        object.position.set(-480, 365, 295);
